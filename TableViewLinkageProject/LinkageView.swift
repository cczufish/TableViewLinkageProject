...
class LinkageView: UIView {
    ...
    lazy var rightTableView: UITableView = {
        let tableView = UITableView(frame: CGRect(x: 0, y: 0, width: ScreenSize.width, height: self.bounds.size.height), style: .plain)
...
//        }
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        if scrollView == rightTableView {
            ...
            leftTableView.contentOffset.y = lastOffsetY
        }
    }
